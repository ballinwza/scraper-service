...
// HelloRequest คือโครงสร้างข้อมูลคำร้องขอ
...
// HelloResponse คือโครงสร้างข้อมูลคำตอบรับ
...
const file_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x10helloworld.proto\x12\rhelloworld.v1\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"G\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\x03R\ttimestamp2W\n" +
	"\x0eGreeterService\x12E\n" +
	"\bSayHello\x12\x1b.helloworld.v1.HelloRequest\x1a\x1c.helloworld.v1.HelloResponseBJZHgithub.com/ballinwza/scraper-service/internal/delivery/proto/v1;gen_grpcb\x06proto3"
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.v1.GreeterService.SayHello:input_type -> helloworld.v1.HelloRequest
	1, // 1: helloworld.v1.GreeterService.SayHello:output_type -> helloworld.v1.HelloResponse
